...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      <header
        ref={headerRef}
        className={`indv-mainheader ${scrolled ? "shrink" : ""}`}
      >
        {/* Effortless Works logo */}
        <Link href="/" className="indv-logo-link">
          <Image
        ...
        {/* Business logo */}
        <Link href="/000002/individual" className="indv-logo-link">
          <Image
            src="/nav-titles/indv-nav.svg"
            alt="Effortless Works"
            width={280}
            height={280}
            className="indv-logo2"
          />
        </Link>

        {/* Nav buttons visible only if showNav is true */}
        {showNav && (
          <nav className="indv-mainnav">
            {/* Left group */}
            <div className="nav-left">
              <Link href="/" className="indv-Home-button">
                Main Home
              </Link>

              <Link href="/000002/individual" className="indv-mainnav-link">
                Individuals 🏠
              </Link>
            </div>
            ...
            <div className="nav-right">
              <button
                onClick={() => scrollToSection("lifetracker")}
                className="indv-newsletter-button"
              >
                Life Tracker
              </button>

              <button
                onClick={() => scrollToSection("personaltracker")}
                className="indv-newsletter-button"
              >
                Personal Trackers
              </button>
