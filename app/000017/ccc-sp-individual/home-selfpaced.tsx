...
const SelfPacedSection: React.FC = () => {
  return (
    <div className="selfpaced-section-container">
      <h1>Self Paced Individual Courses Section</h1>
      <p>This is placeholder content for the Self Paced Individual Courses section.</p>

      {/* Button linking to another page */}
      <Link href="/000015/p-selfpaced"> {/* Replace '/target-page' with your page path */}
        <button className="link-button">
          Goes to Self Paced Individual Courses Page
        </button>
      </Link>
    </div>
  );
