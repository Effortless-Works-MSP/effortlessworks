    ...
    <>
      <header className={`mainheader ${scrolled ? "shrink" : ""}`}>
        ...
        <nav className="mainnav">
          ...
          <Link href="/000002/business#backoffice" className="newsletter-button">
            Back Office
          </Link>

          <Link href="/000002/business#projectmanagement" className="newsletter-button">
            Project Management
          </Link>

          <Link href="/000002/business#howtos" className="newsletter-button">
            How Tos
          </Link>
        </nav>
      </header>
