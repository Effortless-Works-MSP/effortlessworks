...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      <header
        ref={headerRef}
        className={`courses-mainheader ${scrolled ? "shrink" : ""}`}
      >
        {/* Effortless Works logo */}
        <Link href="/" className="courses-howto-logo-link">
          <Image
            src="/Website-Logo/effortlessworksdark.svg"
            alt="Effortless Works Logo"
            width={180}
            height={180}
            className="courses-howto-logo"
          />
        </Link>

        {/* Courses logo */}
        <Link href="/000002/courses" className="courses-howto-logo-link">
          <Image
            src="/nav-titles/courses-nav.svg"
            alt="Effortless Works"
            width={320}
            height={320}
            className="courses-howto-logo2"
          />
        </Link>

        {/* Nav buttons visible only if showNav is true */}
        {showNav && (
          <nav className="courses-mainnav">
            {/* Left group */}
            <div className="nav-left">
              <Link href="/" className="courses-home-button">
                Main Home
              </Link>

              <Link href="/000002/courses" className="courses-mainnav-link">
                Courses 📚
              </Link>
            </div>
            ...
            <div className="nav-right">
              <button
                ...
                className="courses-howto-newsletter-button"
              >
                Product Videos
              </button>
