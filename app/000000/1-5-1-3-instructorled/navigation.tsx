...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      <header
        ref={headerRef}
        className={`courses-il-mainheader ${scrolled ? "shrink" : ""}`}
      >
        {/* Effortless Works logo */}
        <Link href="/" className="courses-il-logo-link">
          <Image
            src="/Website-Logo/effortlessworksdark.svg"
            alt="Effortless Works Logo"
            width={180}
            height={180}
            className="courses-il-logo"
          />
        </Link>

        {/* Courses logo */}
        <Link href="/000002/courses" className="courses-il-logo-link">
          <Image
            src="/nav-titles/courses-nav.svg"
            alt="Effortless Works"
            width={320}
            height={320}
            className="courses-il-logo2"
          />
        </Link>
        ...
        {showNav && (
          <nav className="business-howto-mainnav">
            ...
            <div className="nav-left">
              <Link href="/" className="courses-il-home-button">
                Main Home
              </Link>

              <Link href="/000002/courses" className="courses-il-mainnav-link">
                Courses 📚
              </Link>

              <Link href="/000017/c-instructorled" className="courses-il-mainnav-link">
            ...
            <div className="nav-right">
              ...
              <button
                ...
                className="courses-il-newsletter-button"
              >
                Business
              </button>
